...
const VOICE_FILES: VoiceFile[] = [
  { name: "Michael", url: "", publicId: "sample" },
];
//   https://res.cloudinary.com/xxxxx/video/upload/voices/voices/Michael.wav
...
export default function CreatePage() {
  ...
  const [selectedVoice, setSelectedVoice] = useState(VOICE_FILES[0]?.url ?? "");
  //   https://res.cloudinary.com/xxxxx/video/upload/voices/voices/Michael.wav
  const [exaggeration, setExaggeration] = useState(0.5);
  const [cfgWeight, setCfgWeight] = useState(0.5);
  const [generatedAudios, setGeneratedAudios] = useState<GeneratedAudio[]>([]);
  const [currentAudio, setCurrentAudio] = useState<GeneratedAudio | null>(null);
  const [userUploadedVoices, setUserUploadedVoices] = useState<VoiceAsset[]>(
    [],
  );
